...
#if defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_LUCAS) || defined(CONFIG_MACH_TASSATT) || defined(CONFIG_MACH_TASSTMO) || defined(CONFIG_MACH_GT2) || defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_GIOATT)
unsigned int Volume_Up_irq = 0;
unsigned int Volume_Down_irq = 0;
#endif

extern int board_hw_revision;
#if defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)  || defined(CONFIG_MACH_TASSATT) || defined(CONFIG_MACH_TASSTMO) || defined(CONFIG_MACH_GT2) || defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_GIOATT)
...
#if defined(CONFIG_MACH_EUROPA) || defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_GT2)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS) || defined(CONFIG_MACH_GIOATT)
int key_pressed;
...
#if defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_GT2) ||defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_GIOATT)
...
//choh-tsp
extern void check_recover_tsp(void);
// hsil
int volup_cnt = 0;
		...
		if (keycode == KEY_RESERVED) {
			...
			if (mi->flags & GPIOKPF_PRINT_MAPPED_KEYS)
				pr_info("gpiomatrix: key %x, %d-%d (%d-%d) "
					...
					out, in, mi->output_gpios[out],
					mi->input_gpios[in], pressed);
#if defined(CONFIG_MACH_EUROPA) || defined(CONFIG_MACH_CALLISTO)  || defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS)  || defined(CONFIG_MACH_GIOATT)
			if(!power_off_done) {
#if defined(CONFIG_MACH_LUCAS)
...
#if defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_FLIPBOOK)
				if(keycode == KEY_HOME && pressed == 1)
					TSP_forced_release_forkey();
#endif
#if defined(CONFIG_MACH_CALLISTO)  || defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_GT2)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS)
                        if (key_log_enable>=1)
...
static irqreturn_t gpiokey_irq_handler(int irq_in, void *dev_id)
{
	...
	else if (key_status == 1) // 1 : release
	{
		...
		printk("key event (keycode:%d, pressed:%d)\n", KEY_END, 0); //sec: sm.kim
        		        ...
        		        printk("key event (pressed:%d)\n",0);
		key_pressed = 0;
#if defined(CONFIG_MACH_COOPER)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_FLIPBOOK) 
		TSP_forced_release_forkey();
#endif
	}
...
#if defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSATT) || defined(CONFIG_MACH_TASSTMO)
...
#if !defined (CONFIG_MACH_LUCAS) && !defined(CONFIG_MACH_GT2)&& !defined(CONFIG_MACH_TASSATT)&& !defined(CONFIG_MACH_TASSTMO) && !defined(CONFIG_MACH_FLIPBOOK) //ADD_FB key
...
//#if defined (CONFIG_MACH_TASS) || defined (CONFIG_MACH_GT2) || defined(CONFIG_MACH_TASSATT) || defined(CONFIG_MACH_TASSTMO) || defined(CONFIG_MACH_FLIPBOOK) 
...
#if defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_GT2)|| defined(CONFIG_MACH_FLIPBOOK)
#if defined(CONFIG_KERNEL_SEC_MMICHECK)
